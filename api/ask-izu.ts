...
const SUPPORTIVE_RESPONSES = {
  ...
  th: {
    ...
    general:
      'อีซึไม่สามารถช่วยเรื่องนี้ผ่านการอ่านไพ่ได้ หากเกี่ยวข้องกับความปลอดภัย สุขภาพ กฎหมาย หรือการเงิน ลองขอความช่วยเหลือจากผู้เชี่ยวชาญหรือคนที่คุณไว้ใจนะ',
  },
} as const;
